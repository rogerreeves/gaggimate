...
extern void ui_event_GrindScreen_refreshButton(lv_event_t *e);
extern void ui_event_GrindScreen_beanButton(lv_event_t *e);
extern void ui_event_GrindScreen_brewButton(lv_event_t *e);
extern void ui_event_GrindScreen_addMoreButton(lv_event_t *e);
extern lv_obj_t *ui_GrindScreen_refreshButton;
extern lv_obj_t *ui_GrindScreen_beanButton;
extern lv_obj_t *ui_GrindScreen_brewButton;
extern lv_obj_t *ui_GrindScreen_addMoreButton;
extern void ui_event_GrindScreen_startButton(lv_event_t *e);
extern lv_obj_t *ui_GrindScreen_startButton;
extern lv_obj_t *ui_GrindScreen_doseCountIcon;
extern lv_obj_t *ui_GrindScreen_doseCountRow;
extern lv_obj_t *ui_GrindScreen_doseCountLabel;
extern void ui_event_GrindScreen_doseCountUp(lv_event_t *e);
extern lv_obj_t *ui_GrindScreen_doseCountUp;
extern void ui_event_GrindScreen_doseCountDown(lv_event_t *e);
extern lv_obj_t *ui_GrindScreen_doseCountDown;
