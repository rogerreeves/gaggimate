...
void ui_GrindScreen_screen_init(void) {
    ...
    lv_obj_t *ui_GrindScreen_background = lv_img_create(ui_GrindScreen);
    lv_img_set_src(ui_GrindScreen_background, &ui_img_background_minimal);
    lv_obj_set_align(ui_GrindScreen_background, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_GrindScreen_background, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_GrindScreen_background, LV_OBJ_FLAG_SCROLLABLE);
